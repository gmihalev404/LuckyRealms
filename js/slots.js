...
const gameKey =
    params.get("game") || "dragon";

const game =
    window.GAME_CONFIGS[gameKey] ||
...
function highlightBonusSymbols(grid) {
    for (
        let row = 0;
        row < ROWS;
        row++
